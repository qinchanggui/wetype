...
export default function PreviewPanel({
    ...
    return (
        <div
            ...
            className="relative overflow-y-auto no-scrollbar bg-[#f2f2f7]/50 flex flex-col z-20 flex-1 min-h-0 w-full overflow-x-hidden"
        >
            <div className="mt-12 mb-32 ml-4 md:ml-6 mr-auto w-[640px] max-w-[95%] h-fit min-h-[calc(100%-48px)]">
